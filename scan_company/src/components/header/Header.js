...
const Header = () => {
    ...
    return (
        <header className={styles.header} style={active ? {backgroundColor: '#029491'} : {}}>
            ...
            <Link to={'/'}>
            <img className={styles.logo} src={active ? "/logo/header/scanlogo.svg" : "/logo/header/scanlogo2.svg"} alt="scanlogo" style={active ? {marginTop: '10px'} : {}}/>
            </Link>
            ...
            <div className={styles.signed}>
                ...
                <div className={styles.user}>
                    ...
                    <img className={styles.userpic} src="/logo/header/alex.png" alt="user"/>
                </div>
            </div>    
            }

    ...
    const responsive = {
      ...
      const CustomLeftArrow = ({ onClick, ...restArrowProps }) => (
        <button
          ...
          style={{ backgroundImage: 'url(/logo/mainelements/whywe/leftarrow.svg)' }}
      ...
      const CustomRightArrow = ({ onClick, ...restArrowProps }) => (
        <button
          ...
          style={{ backgroundImage: 'url(/logo/mainelements/whywe/rightarrow.svg)' }}
  ...
  >
    ...
    <div
      ...
      style={
        windowWidth > 800
          ? {
              backgroundImage: 'url(/logo/mainelements/whywe/sitsman.svg)',
            }
          : {
              backgroundImage: 'url(/logo/mainelements/whywe/sitsman-adapt.svg)',
            }
      }
    ></div>
  </section>

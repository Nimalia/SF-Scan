      ...
      word = 'слова'
        ...
        word = 'слов'
          ...
          <div className={styles.articles_card} key={item.id}>
            ...
            <img className={styles.articles_img} src={src && imgChecked ? src : '/logo/searchresult/notDownload.svg'} style={src && imgChecked ? {objectFit: 'cover'} : {border: '1px solid #94949445'}} alt="article illustration"/>
